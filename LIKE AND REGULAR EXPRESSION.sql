...
INSERT INTO books(id, title, author, year, genre)
VALUES(6, "Breaking Dawn", "Stephenie Meyer", 1876, "Fiction");
...
SELECT * FROM books WHERE title REGEXP "^.{9}$";
...
#DOUBT
#Write a query to find all books where the title starts with the letter 'B' and contains exactly two words using the REGEXP operator.
SELECT * FROM books WHERE title REGEXP "^B__";
